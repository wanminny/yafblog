 ...
 * @author chenzhouyu
 * 类用法
 * $ImageCode = new Util_ImageCode();
 * $ImageCode->doimage();
 * //取得验证
 * $_SESSION['code']=$ImageCode->get_code();
 */
class Util_ImageCode {
	//验证码的宽度
	public $width=130;
	...
	function __construct() {
		...
		if($rand==0) {
		    $this->font = APPLICATION_PATH.DIRECTORY_SEPARATOR.APP_NAME.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.'font'.DIRECTORY_SEPARATOR.'elephant.ttf';
		} else {
			$this->font =  APPLICATION_PATH.DIRECTORY_SEPARATOR.APP_NAME.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.'font'.DIRECTORY_SEPARATOR.'Vineta.ttf';
		}
	}
